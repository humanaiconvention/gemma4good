"""Re-grade existing v39 GGUF Q5_K_M v2-security data with v5 rubric."""
...
def main():
    src = Path("experiments/v39_gguf_v2_security_only.json")
    d = json.loads(src.read_text())
    regraded = [regrade_record(r) for r in d["sampling"]]

    by_scen = defaultdict(list)
    for r in regraded:
        by_scen[r["scenario_id"]].append(r)

    print("v39 GGUF Q5_K_M v2-security re-graded under v5 rubric")
    print("=" * 60)
    total_pass = 0
    total_n = 0
    real_compliance = 0
    ...
    out_path = Path("experiments/v39_gguf_v2_security_full_v5.json")
