...
- Local clean worktree: `D:\gemma4good\_local_worktrees\clean-local-history`
  This is a clean local branch descended from the original local repository history.
- Remote-based clean worktree: `D:\gemma4good\_local_worktrees\clean-github-aligned`
...
- Use `D:\gemma4good\_local_worktrees\clean-github-aligned` for future commits that should line up with GitHub.
